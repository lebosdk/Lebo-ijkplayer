...
#define JNI_MODULE_PACKAGE      "lebotv/danmaku/ijk/media/player"
#define JNI_CLASS_IJKPLAYER     "lebotv/danmaku/ijk/media/player/IjkMediaPlayer"
#define JNI_IJK_MEDIA_EXCEPTION "lebotv/danmaku/ijk/media/player/exceptions/IjkMediaException"
...
static JNINativeMethod g_methods[] = {
    ...
    { "_setDataSource",         "(Llebotv/danmaku/ijk/media/player/misc/IMediaDataSource;)V", (void *)IjkMediaPlayer_setDataSourceCallback },
    { "_setAndroidIOCallback",  "(Llebotv/danmaku/ijk/media/player/misc/IAndroidIO;)V", (void *)IjkMediaPlayer_setAndroidIOCallback },
