...
static const AVOption ffp_context_options[] = {
    ...
    { "mediacodec-sps-pps-usage",                               "MediaCodec: sps pps data set type",
        OPTION_OFFSET(mediacodec_sps_pps_usage),
        OPTION_INT(MEDIACODEC_SPS_PPS_SET_CSD,
                   MEDIACODEC_SPS_PPS_SET_CSD,
                   MEDIACODEC_SPS_PPS_SET_CSD_AND_FRAME) },
