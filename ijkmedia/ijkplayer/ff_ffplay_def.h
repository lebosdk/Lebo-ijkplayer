...
// Mediacodec sps pps data set type
#define MEDIACODEC_SPS_PPS_SET_CSD 0
#define MEDIACODEC_SPS_PPS_SET_FRAME 1
#define MEDIACODEC_SPS_PPS_SET_CSD_AND_FRAME 2
...
inline static void ffp_reset_internal(FFPlayer *ffp)
{
    ...
    ffp->mediacodec_sps_pps_usage       = 0; // option
